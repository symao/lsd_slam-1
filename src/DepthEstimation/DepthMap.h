...
public:
    ...
    /**
     * does propagation and whole-filling-regularization (no observation, for that need to call
     *updateKeyframe()!)
     **/
...
private:
    ...
    inline float doLineStereo(const float u, const float v, const float epxn, const float epyn,
    ...
    // float clocksPropagate, clocksPropagateKF, clocksObserve, msObserve, clocksReg1, clocksReg2,
    // msReg1, msReg2, clocksFinalize;
};
