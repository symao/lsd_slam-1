...
void GUI::initImages() {
    depthImg = new pangolin::GlTexture(Resolution::getInstance().width(),
                                       Resolution::getInstance().height(), GL_RGB, true, 0, GL_RGB,
                                       GL_UNSIGNED_BYTE);
...
void GUI::drawFrustum() {
    ...
    glBegin(GL_LINES);
    glVertex3f(0, 0, 0);
    glVertex3f(0.05 * (0 - Intrinsics::getInstance().cx()) / Intrinsics::getInstance().fx(),
               0.05 * (0 - Intrinsics::getInstance().cy()) / Intrinsics::getInstance().fy(), 0.05);
    glVertex3f(0, 0, 0);
    glVertex3f(0.05 * (0 - Intrinsics::getInstance().cx()) / Intrinsics::getInstance().fx(),
               0.05 * (Resolution::getInstance().height() - 1 - Intrinsics::getInstance().cy()) /
                   Intrinsics::getInstance().fy(),
               0.05);
    glVertex3f(0, 0, 0);
    glVertex3f(0.05 * (Resolution::getInstance().width() - 1 - Intrinsics::getInstance().cx()) /
