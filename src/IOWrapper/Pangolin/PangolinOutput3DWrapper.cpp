...
void PangolinOutput3DWrapper::updateImage(unsigned char* data) { gui.updateImage(data); }
...
void PangolinOutput3DWrapper::publishTrajectory(std::vector<Eigen::Matrix<float, 3, 1>> trajectory,
                                                std::string identifier) {
    // TODO
}

void PangolinOutput3DWrapper::publishTrajectoryIncrement(Eigen::Matrix<float, 3, 1> pt,
                                                         std::string identifier) {
    // TODO
}
