...
public:
    ...
    /** Maps frame ids to keyframes. Contains ALL Keyframes allocated, including the one that
    ...
    // it is put to the end of this list; frames for re-tracking are always chosen from the first
    // third of this list.
